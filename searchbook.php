    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="container">
            <div class="page-header">
              <h1 class="all-tittles">Sistema Archivo <small>Búsqueda de Carpeta</small></h1>
            </div>
        </div>
        <br><br><br>
        <?php
        ...
        if($checktotalBook >0){
                ...
                <div class="container-fluid">
                    ...
                    ';
                        $countBook=1;
                        while ($bookNameInfo=mysqli_fetch_array($checkNameBook)){
                        echo '<li>
                            <div class="media media-hover">
                              <div class="media-left media-middle">
                                  <a href="infobook.php?codeBook='.$bookNameInfo['CodigoLibro'].'" class="tooltips-general" data-toggle="tooltip" data-placement="right" title="Más información de la carpeta">
                              ...
                              <div class="media-body">
                                ...
                                <div class="pull-left">
                                    <strong>Dirección: </strong>'.$bookNameInfo['Autor'].'<br>
                                    <strong>Código Referencia: </strong>'.$bookNameInfo['Pais'].'<br>
                                </div>
            ...
            echo '<h2 class="text-center"><i class="zmdi zmdi-mood-bad zmdi-hc-5x"></i><br><br>Lo sentimos, no hemos encontrado ninguna carpeta con el nombre <strong>'.$BookNameSearch.'</strong> en el sistema</h2>';
        }
