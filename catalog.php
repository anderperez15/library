    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="container">
            <div class="page-header">
              <h1 class="all-tittles">Sistema Archivo <small>Catálogo de Carpetas</small></h1>
            </div>
        </div>
         <div class="container-fluid"  style="margin: 40px 0;">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                    Bienvenido al catálogo, selecciona una categoría de la lista para empezar, si deseas buscar una carpeta por nombre o dirección has click en el icono &nbsp; <i class="zmdi zmdi-search"></i> &nbsp; que se encuentra en la barra superior
                </div>
            </div>
        </div>
        <?php
            ...
            if(mysqli_num_rows($checkingAllBooks)>0){
                ...
                if($VarCategoryCatalog==''){
                    ...
                    if(mysqli_num_rows($checkCodeBook)>0){
                            ...
                            $dataCategC=mysqli_fetch_array($selectCategC);
                            echo '<p class="text-center lead all-tittles" style="padding: 0 25px;">Se muestran las carpetas de la categoría '.$dataCategC['Nombre'].'</p><br>';
                            mysqli_free_result($selectCategC);
                            echo '<div class="container-fluid">
                                <ul id="itemContainer" class="list-unstyled">';
                                    $countBook=1;
                                    while ($bookCodeInfo=mysqli_fetch_array($checkCodeBook)){
                                    echo '<li>
                                        <div class="media media-hover">
                                          <div class="media-left media-middle">
                                              <a href="infobook.php?codeBook='.$bookCodeInfo['CodigoLibro'].'" class="tooltips-general" data-toggle="tooltip" data-placement="right" title="Más información de carpeta">
                                          ...
                                          <div class="media-body">
                                            ...
                                            <div class="pull-left">
                                                <strong>Dirección: </strong>'.$bookCodeInfo['Autor'].'<br>
                                                <strong>Código Referencia: </strong>'.$bookCodeInfo['Pais'].'<br>
                                            </div>
                                            <p class="text-center pull-right">
                                                <a href="#" class="btn btn-info btn-xs btn-info-book" style="margin-right: 10px;" data-code-book="'.$bookCodeInfo['CodigoLibro'].'"><i class="zmdi zmdi-info-outline"></i> &nbsp;&nbsp; Detalles</a>
                                            </p>
                                          </div>
                                        </div>
                                    </li>';
                        ...
                        echo '<br><br><br><p class="lead text-center all-tittles">no hay carpetas registradas en esta categoría</p><br><br><br><br><br><br>'; 
                    }
                    mysqli_free_result($checkCodeBook);
                }
            }else{
                echo '<br><br><br><p class="lead text-center all-tittles">no hay carpetas registradas en el sistema</p><br><br><br><br><br><br>';
            }
