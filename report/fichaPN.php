...
$pdf->Cell (0,5,utf8_decode('Registro de préstamos de libros de biblioteca a personal administrativo que'),0,1,'C');
$pdf->Ln(7);
$pdf->Cell (0,5,utf8_decode('labora en el '.$dataInstitution['Nombre'].', durante el año '.$CurrentYear.''),0,1,'C');
$pdf->Ln(20);
