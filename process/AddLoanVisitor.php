...
if($totalBL>1){
    ...
    $totalChecked=0;
    while($tmp=mysqli_fetch_array($checkLoanVisitor)){
            ...
            if($firstDate<$secondDate || $firstDate==$secondDate){
                ...
                if(mysqli_num_rows($checkCorrelative)<=0){
                    ...
                    echo '<script type="text/javascript">
                        swal({ 
                            title:"¡Ocurrió un error inesperado!", 
                            text:"La carpeta que corresponde al código correlativo que acabás de ingresar se encuentra en un préstamo vigente, por favor verifica e intenta nuevamente", 
                            type: "error", 
                            confirmButtonText: "Aceptar" 
                        });
                    </script>';
