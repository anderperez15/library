...
$dataInst=mysqli_fetch_array($bookCheckInstitution);
...
if(mysqli_num_rows($bookCheckInstitution)>0){
    if(!$bookCategory=="" && !$bookProvider=="" && !$bookOffice=="" && !$bookState==""){
           ...
           if(consultasSQL::InsertSQL("libro", "CodigoLibro, CodigoCorrelativo, CodigoCategoria, CodigoProveedor, CodigoInfraestructura, Autor, Pais, Year, Estimado, Titulo, Edicion, Ubicacion, Cargo, Editorial, Existencias, Prestado,Estado", "'$bookCode','$bookCorrelative','$bookCategory','$bookProvider','$bookInstitution','$bookAutor','$bookCountry','$bookYear','$bookEstimated','$bookName','$bookEdition','$bookLocation','$bookOffice','$bookEditorial','$bookCopies','$bookBorrowed','$bookState'")){
               echo '<script type="text/javascript">
                    swal({
                       ...
                       text:"Los datos de la carpeta se registraron correctamente",
                       type: "success",
                ...
                echo '<script type="text/javascript">
                    swal({
                       ...
                       text:"No se pudo registrar la carpeta, por favor intenta nuevamente",
                       type: "error",
                       confirmButtonText: "Aceptar"
                    });
                </script>';
            ...
            echo '<script type="text/javascript">
                swal({
                   title:"¡Ocurrió un error inesperado!",
                   text:"La informacción correspondiente a la carpeta que quieres registrar ya está almacenada en el sistema",
                   type: "error",
                   confirmButtonText: "Aceptar"
                });
            </script>'; 
        ...
        echo '<script type="text/javascript">
            swal({
               title:"¡Ocurrió un error inesperado!",
               text:"Verifica que hayas seleccionado una categoría, proveedor, cargo y estado de la carpeta válidos. Si aún tienes problemas verifica que tengas categorías y proveedores registrados en el sistema",
               type: "error",
               confirmButtonText: "Aceptar"
            });
        </script>';
    ...
    echo '<script type="text/javascript">
        swal({
           title:"¡Ocurrió un error inesperado!",
           text:"No has registrado los datos del archivo, por favor registralos para poder registrar carpetas",
           type: "error",
           confirmButtonText: "Aceptar"
        });
    </script>'; 
