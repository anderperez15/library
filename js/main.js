$(document).ready(function(){
    ...
    $('.search-book-button').click(function(e){
        ...
        swal({
           title: "¿Qué carpeta estás buscando?",
           text: "Por favor escribe el nombre de la carpeta",
           type: "input",   
           showCancelButton: true,
           closeOnConfirm: false,
           animation: "slide-from-top",
           ...
           inputPlaceholder: "Escribe aquí el nombre de la carpeta" }, 
      function(inputValue){
           if (inputValue === false) return false;  

           if (inputValue === "") {
               swal.showInputError("Debes escribir el nombre de la carpeta");     
               return false;   
           } 
            ...
            success:function(data){
                if(data==="Avaliable"){
                    ...
                    swal({
                       ...
                       text:"No puedes registrar carpetas por el momento, primero debes de agregar los datos del archivo, administradores y categorías. Ve a la opción Administración del menu",
                       type: "error",
