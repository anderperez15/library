        ...
        <div class="container-fluid"  style="margin: 50px 0;">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                    Bienvenido a la sección donde se encuentra el listado de proveedores. Puedes actualizar o eliminar los datos del proveedor, si hay carpetas asociados al proveedor no podrás eliminarlo.
                </div>
            </div>
        </div>
        <div class="container-fluid">
