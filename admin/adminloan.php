    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="container">
            <div class="page-header">
              <h1 class="all-tittles">Sistema Archivo <small>préstamos y reservaciones</small></h1>
            </div>
        </div>
        ...
        <div class="container-fluid"  style="margin: 50px 0;">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                    Bienvenido a esta sección, aquí se muestran todos los préstamos de carpetas realizados hasta la fecha y que ya se entregaron satisfactoriamente
                </div>
            </div>
        </div>
        <div class="container-fluid">
            ...
            <?php
                $checkAllLoans=ejecutarSQL::consultar("SELECT * FROM prestamo WHERE Estado='Entregado' ORDER BY FechaSalida ASC");
                if(mysqli_num_rows($checkAllLoans)>=1){
                    ...
                    while($data=mysqli_fetch_array($checkAllLoans)){
                        $f++;
                        ...
                        if(mysqli_num_rows($checkLoanU3)>=1){
                            $dataU3=mysqli_fetch_array($checkLoanU3);
                            ...
                            <div class="table-responsive">
                                <div class="div-table" style="margin:0 !important;">
                                    <div class="div-table-row div-table-row-list">
                                        ...
                                        <form action="../process/DeleteLoan.php" method="post" class="div-table-cell form_SRCB" data-type-form="delete" style="width: 8%;">
                                            <input type="hidden" value="'.$data['CodigoPrestamo'].'" name="LoanKey">
                                            <input type="hidden" value="'.$typeUser.'" name="UserType">
