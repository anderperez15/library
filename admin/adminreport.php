        ...
        $(document).ready(function(){
            $('.btn-file').on('click', function(){
                ...
                if(file_type==="file"){
                    ...
                    text2="No puedes generar fichas, primero debes de registrar los datos del archivo. Ve a la opción Administración del menú y luego a Datos Archivo";
                }
                if(file_type==="report"){
                    file=$(this).attr('data-file');
    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="container">
            <div class="page-header">
              <h1 class="all-tittles">Sistema Archivo <small>Reportes y estadísticas</small></h1>
            </div>
        </div>
                    ...
                    <div class="container-fluid"  style="margin: 50px 0;">
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                                Bienvenido al área de estadísticas, aquí puedes ver las diferentes estadísticas de préstamos y carpetas.
                            </div>
                        </div>
                    </div>
                ...
                <div role="tabpanel" class="tab-pane fade" id="bitacora">
                    <div class="container-fluid"  style="margin: 50px 0;">
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                                Bienvenido al área de bitácora, aquí se muestran los registros de los últimos 15 usuarios (administradores, usuarios especiales, usuarios generales o externos) que han iniciado sesión en el sistema. Recuerda eliminar los registros de la bitácora cada año para que el sistema funcione correctamente.
                            </div>
                        </div>
                    </div>
                ...
                <div role="tabpanel" class="tab-pane fade" id="reports">
                    <div class="container-fluid"  style="margin: 50px 0;">
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                                Bienvenido al área de reportes, aquí puedes generar fichas de préstamos vacías de usuarios en formato pdf, también puedes generar reportes de inventario entre otros.
                            </div>
                        </div>
                    </div>
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-4">
                                <div class="full-reset report-content">
                                    ...
                                    <h3 class="text-center">Ficha Usuarios Generales</h3>
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-6 col-md-4">
                                <div class="full-reset report-content">
                                    ...
                                    <h3 class="text-center">Ficha Usuarios Especiales</h3>
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-6 col-md-4">
                                <div class="full-reset report-content">
                                    ...
                                    <h3 class="text-center">Ficha Usuarios Externos</h3>
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-6 col-md-4">
                                <div class="full-reset report-content">
                                    ...
                                    <h3 class="text-center">Ficha Visitantes</h3>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-4">
                                <div class="full-reset report-content">
                                    ...
                                    <h3 class="text-center">Reporte Carpetas por Categoría</h3>
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-6 col-md-4">
                                <div class="full-reset report-content">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-4">
                                <div class="full-reset report-content">
                                    ...
                                    <h3 class="text-center">Préstamos Entregados (por áreas)</h3>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-4">
                                <div class="full-reset report-content">
                                    ...
                                    <h3 class="text-center">Usuarios Especiales</h3>
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-6 col-md-4">
                                <div class="full-reset report-content">
                                    ...
                                    <h3 class="text-center">Usuarios Externos</h3>
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-6 col-md-4">
                                <div class="full-reset report-content">
                                    ...
                                    <h3 class="text-center">Usuarios Generales</h3>
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-6 col-md-4">
                                <div class="full-reset report-content">
