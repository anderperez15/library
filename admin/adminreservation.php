         ...
         <div class="container-fluid" style="margin: 50px 0;">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                    Bienvenido a esta sección, aquí se muestran las reservaciones de carpetas hechas por los usuarios, las cuales están pendientes para ser aprobadas por ti
                </div>
            </div>
        </div>
        <div class="container-fluid">
            ...
            <?php
                ...
                if(mysqli_num_rows($checkingRservations)>=1){
                    echo '<div class="table-responsive">
                        <div class="div-table" style="margin:0 !important;">
                            <div class="div-table-row div-table-row-list" style="background-color:#DFF0D8; font-weight:bold;">
                                ...
                                <div class="div-table-cell" style="width: 22%;">Nombre de Carpeta</div>
                    ...
                    while($data=mysqli_fetch_array($checkingRservations)){
                        $y++;
                        ...
                        if(mysqli_num_rows($checkReserU1)>=1){
                            $dataU1=mysqli_fetch_array($checkReserU1);
                        ...
                        if(mysqli_num_rows($checkReserU2)>=1){
                            $dataU2=mysqli_fetch_array($checkReserU2);
                        ...
                        if(mysqli_num_rows($checkReserU3)>=1){
                            $dataU3=mysqli_fetch_array($checkReserU3);
            ...
            <div class="modal-dialog" role="document">
                <form class="modal-content form_SRCB" action="../process/UpdateReservation.php" method="post" data-type-form="approveReservation" >
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title all-tittles text-center">selecciona el ID a gestionar</h4>
                    </div>
