        ...
        <div class="container-fluid"  style="margin: 50px 0;">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                    Bienvenido a la sección donde se encuentra el listado de los usuarios externos registrados en el sistema, puedes actualizar algunos datos o eliminar el registro completo siempre y cuando no tenga préstamos pendientes.<br>
                    <strong class="text-danger"><i class="zmdi zmdi-alert-triangle"></i> &nbsp; ¡Importante! </strong>Si eliminas algún usuario externo del sistema se borrarán todos los datos relacionados con él, incluyendo préstamos y registros en la bitácora.
                </div>
            </div>
        </div>
        <div class="container-fluid">
            <div class="row">
                <div class="col-xs-12 lead">
                    <ol class="breadcrumb">
                        <li><a href="adminpersonal.php">Nuevo Usuario Externo</a></li>
                        <li class="active">Listado Usuarios Externos</li>
                    </ol>
                </div>
            </div>
        </div>
        <div class="container-fluid">
            <form class="pull-right" style="width: 30% !important;" action="adminlistpersonal.php" method="get" autocomplete="off">
                <div class="group-material">
                    <input type="search" style="display: inline-block !important; width: 70%;" class="material-control tooltips-general" placeholder="Buscar usuario externo" name="PersonalN" required="" pattern="[a-zA-ZáéíóúÁÉÍÓÚ ]{1,50}" maxlength="50" data-toggle="tooltip" data-placement="top" title="Escribe los nombres, sin los apellidos">
                    <button class="btn" style="margin: 0; height: 43px; background-color: transparent !important;">
                        <i class="zmdi zmdi-search" style="font-size: 25px;"></i>
                    </button>
                </div>
            </form>
            <h2 class="text-center all-tittles" style="clear: both; margin: 25px 0;">listado de usuarios externos</h2>
            ...
            <?php
                if(!$PersonalN==""){
                    ...
                    if(mysqli_num_rows($selectPersonalByName)>=1){
                        ...
                        $c=1;
                        while($dataP=mysqli_fetch_array($selectPersonalByName)){
                            echo '<li>
                                <div class="table-responsive">
                                    <div class="div-table" style="margin:0 !important;">
                        ...
                        echo '<br><br><br><h2 class="text-center all-tittles">No hay usuario externo registrado con el nombre "'.$PersonalN.'" en el sistema</h2><br><br><br>';
                    }
                    ...
                    if(mysqli_num_rows($selectAllPersonal)>=1){
                        echo '<ul id="itemContainer" class="list-unstyled">';
                        $c=1;
                        while($data=mysqli_fetch_array($selectAllPersonal)){
                            echo '<li>
                                <div class="table-responsive">
                                    <div class="div-table" style="margin:0 !important;">
                                        <div class="div-table-row div-table-row-list">
                        ...
                        echo '<br><br><br><h2 class="text-center all-tittles">No hay usuario externo registrado en el sistema</h2><br><br><br>';
                    }
        ...
        <div class="modal fade" id="ModalUpdate" tabindex="-1" role="dialog">
          <div class="modal-dialog" role="document">
              ...
              <div class="modal-header">
                ...
                <h4 class="modal-title text-center all-tittles">Actualizar datos usuario externo</h4>
              </div>
