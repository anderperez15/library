        ...
        <div class="container-fluid"  style="margin: 50px 0;">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                    Bienvenido a la sección donde se encuentra el listado de las categorías de carpetas. Puedes actualizar o eliminar los datos de la categoría siempre y cuando no tenga carpetas asociados.
                </div>
            </div>
        </div>
        <div class="container-fluid">
