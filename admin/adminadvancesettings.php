    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="container">
            <div class="page-header">
              <h1 class="all-tittles">Sistema Archivo <small>configuraciones avanzadas</small></h1>
            </div>
        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-4">
                            <div class="report-content">
                                ...
                                <h3 class="text-center all-tittles">eliminar usuarios especiales</h3>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-6 col-md-4">
                            <div class="report-content">
                                ...
                                <h3 class="text-center all-tittles">eliminar usuarios generales</h3>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-6 col-md-4">
                            <div class="report-content">
                                ...
                                <h3 class="text-center all-tittles">eliminar externos</h3>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-6 col-md-4">
                            <div class="report-content">
                                ...
                                <h3 class="text-center all-tittles">eliminar carpetas</h3>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-6 col-md-4">
                            <div class="report-content">
                                ...
                                <h3 class="text-center all-tittles">eliminar bitácora</h3>
                            </div>
                        </div>
                    </div>
                </div>
