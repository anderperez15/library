        ...
        <div class="container-fluid"  style="margin: 50px 0;">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                    Bienvenido a esta sección, aquí se muestran todos los préstamos de carpetas que no han sido devueltas por los diferentes usuarios
                </div>
            </div>
        </div>
        <div class="container-fluid">
            ...
            <?php
                ...
                if(mysqli_num_rows($checkLoansPending)>=1){
                    ...
                    while($data=mysqli_fetch_array($checkLoansPending)){
                        $f++;
