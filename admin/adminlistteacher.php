        ...
        <div class="container-fluid"  style="margin: 50px 0;">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                    Bienvenido a la sección donde se encuentra el listado de usuarios especiales registrados en el sistema, puedes actualizar algunos datos de estos usuarios o eliminar el registro completo siempre y cuando no tenga préstamos asociados.<br>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-xs-12 lead">
                    <ol class="breadcrumb">
                        <li><a href="adminteacher.php">Nuevo Usuario Especial</a></li>
                        <li class="active">Listado de Usuarios Especiales</li>
                    </ol>
                </div>
            </div>
        </div>
        <div class="container-fluid">
            <form class="pull-right" style="width: 30% !important;" action="adminlistteacher.php" method="get" autocomplete="off">
                <div class="group-material">
                    <input type="search" style="display: inline-block !important; width: 70%;" class="material-control tooltips-general" placeholder="Buscar Usuario Especial" name="TeacherN" required="" pattern="[a-zA-ZáéíóúÁÉÍÓÚ ]{1,50}" maxlength="50" data-toggle="tooltip" data-placement="top" title="Escribe los nombres, sin los apellidos">
                    <button class="btn" style="margin: 0; height: 43px; background-color: transparent !important;">
                        <i class="zmdi zmdi-search" style="font-size: 25px;"></i>
                    </button>
                </div>
            </form>
            <h2 class="text-center all-tittles" style="clear: both; margin: 25px 0;">Listado Usuarios Especiales</h2>
            ...
            <?php
                if(!$TeacherN==""){
                    ...
                    if(mysqli_num_rows($selectTeacherByName)>=1){
                        ...
                        echo '<br><br><br><h2 class="text-center all-tittles">no hay usuarios especiales registrados con el nombre "'.$TeacherN.'"</h2><br><br><br>';
                    }
                    ...
                    if(mysqli_num_rows($selectAllTeachers)>=1){
                        echo '<ul id="itemContainer" class="list-unstyled">';
                        $c=1;
                        while($data=mysqli_fetch_array($selectAllTeachers)){
                        ...
                        echo '<br><br><br><h2 class="text-center all-tittles">no hay usuarios especiales registrados en el sistema</h2><br><br><br>';
                    }
          ...
          <div class="modal-dialog" role="document">
            <form class="form_SRCB modal-content" action="../process/UpdateTeacher.php" method="post" data-type-form="update"  autocomplete="off">
              <div class="modal-header">
                ...
                <h4 class="modal-title text-center all-tittles">Actualizar datos de usuario especial</h4>
              </div>
