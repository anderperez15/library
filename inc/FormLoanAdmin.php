<div class="container-fluid">
    <div class="row">
        <div class="col-xs-12">
            ...
            <p class="lead">
                Para realizar un préstamo llena los campos correspondientes a el usuario que realizara el préstamo de la carpeta
            </p>
            <ul class="nav nav-tabs nav-justified" role="tablist">
                <li role="presentation" class="active"><a href="#loan1" aria-controls="home" role="tab" data-toggle="tab">Préstamo Usuario General</a></li>
                <li role="presentation"><a href="#loan2" aria-controls="profile" role="tab" data-toggle="tab">Préstamo Usuario Especial</a></li>
                <li role="presentation"><a href="#loan3" aria-controls="messages" role="tab" data-toggle="tab">Préstamo Usuario Externo</a></li>
                        ...
                        <div class="col-xs-12 col-sm-8 col-sm-offset-2">
                            <form action="process/AddLoanUsers.php" method="post" class="form_SRCB" data-type-form="saveLoan" autocomplete="off">
                                ...
                                <div class="group-material">
                                    ...
                                    <select class="tooltips-general material-control" name="bookCorrelative" data-toggle="tooltip" data-placement="top" title="Elige el código correlativo de la carpeta">
                                        <?php
                                ...
                                <div class="group-material">
                                    <input type="text" class="material-control tooltips-general" placeholder="Escribe aquí el ID del usuario general" name="userKey" required="" maxlength="20" data-toggle="tooltip" data-placement="top" title="ID de Usuario">
                                    <span class="highlight"></span>
                                    <span class="bar"></span>
                                    <label>NIE</label>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-8 col-sm-offset-2">
                            <form action="process/AddLoanUsers.php" method="post" class="form_SRCB" data-type-form="saveLoan" autocomplete="off"> 
                                ...
                                <div class="group-material">
                                    <input type="text" class="material-control tooltips-general" placeholder="Escribe aquí el ID usuario especial" name="userKey" pattern="[0-9-]{1,10}" required="" maxlength="10" data-toggle="tooltip" data-placement="top" title="ID Usuario">
                                    <span class="highlight"></span>
                                    <span class="bar"></span>
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-8 col-sm-offset-2">
                            <form action="process/AddLoanUsers.php" method="post" class="form_SRCB" data-type-form="saveLoan" autocomplete="off"> 
                                ...
                                <div class="group-material">
                                    <input type="text" class="material-control tooltips-general" placeholder="Escribe aquí el ID del usuario externo" name="userKey" pattern="[0-9-]{1,10}" required="" maxlength="10" data-toggle="tooltip" data-placement="top" title="ID Usuario">
                                    <span class="highlight"></span>
                                    <span class="bar"></span>
                                    <label>Número de DUI</label>
                                </div>
                        ...
                        <div class="col-xs-12 col-sm-8 col-sm-offset-2">
                            <form action="process/AddLoanVisitor.php" method="post" class="form_SRCB" data-type-form="saveLoan" autocomplete="off"> 
                               <?php
                                ...
                                <div class="group-material">
                                    <input type="text" class="material-control tooltips-general" placeholder="Escribe aquí el ID del visitante" name="visitorDUI" pattern="[0-9-]{1,10}" required="" maxlength="10" data-toggle="tooltip" data-placement="top" title="ID Usuario">
                                    <span class="highlight"></span>
                                    <span class="bar"></span>
                                    <label>Número de DUI</label>
                                </div>
                                ...
                                <div class="group-material">
                                    <input type="text" class="material-control tooltips-general" placeholder="Escribe aquí el origen del visitante" name="visitorInstitution" pattern="[a-zA-ZáéíóúÁÉÍÓÚ ]{1,60}" required="" maxlength="60" data-toggle="tooltip" data-placement="top" title="Escribe el origen del visitante">
                                    <span class="highlight"></span>
                                    <span class="bar"></span>
                                    <label>Institución de donde visita</label>
                                </div>
                                <div class="group-material">
                                    <input type="text" class="material-control tooltips-general" placeholder="Escribe aquí el número de teléfono del visitante" name="visitorPhone" pattern="[0-9]{1,8}" required="" maxlength="8" data-toggle="tooltip" data-placement="top" title="Solamente números">
                                    <span class="highlight"></span>
                                    <span class="bar"></span>
