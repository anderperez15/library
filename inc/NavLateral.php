...
<div class="navbar-lateral full-reset">
    ...
    <div class="full-reset container-menu-movile custom-scroll-containers">
        ...
        <div class="full-reset" style="background-color:#2B3D51; padding: 10px 0; color:#fff;">
            ...
            <p class="text-center" style="padding-top: 15px;">Sistema de Gestión de Archivo</p>
        </div>
                ...
                <?php
                    if($_SESSION['UserPrivilege']=='Student'||$_SESSION['UserPrivilege']=='Teacher'||$_SESSION['UserPrivilege']=='Personal'){
                        ...
                        <li>
                            ...
                            <ul class="list-unstyled">
                                <li><a href="'.$LinkRouteAdmin.'admininstitution.php"><i class="zmdi zmdi-balance zmdi-hc-fw"></i>&nbsp;&nbsp; Datos Archivo</a></li>
                                ...
                                <li><a href="'.$LinkRouteAdmin.'adminsection.php"><i class="zmdi zmdi-assignment-account zmdi-hc-fw"></i>&nbsp;&nbsp; Nueva Área</a></li>
                            </ul>
                        </li>
                        <li>
                            ...
                            <ul class="list-unstyled">
                                ...
                                <li><a href="'.$LinkRouteAdmin.'adminteacher.php"><i class="zmdi zmdi-male-alt zmdi-hc-fw"></i>&nbsp;&nbsp; Nuevo usuario especial</a></li>
                                <li><a href="'.$LinkRouteAdmin.'adminstudent.php"><i class="zmdi zmdi-accounts zmdi-hc-fw"></i>&nbsp;&nbsp; Nuevo usuario general</a></li>
                                <li><a href="'.$LinkRouteAdmin.'adminpersonal.php"><i class="zmdi zmdi-male-female zmdi-hc-fw"></i>&nbsp;&nbsp; Nuevo personal administrativo</a></li>
                            </ul>
                        </li>
                        <li>
                            <div class="dropdown-menu-button"><i class="zmdi zmdi-assignment-o zmdi-hc-fw"></i>&nbsp;&nbsp; Carpetas y catálogo <i class="zmdi zmdi-chevron-down pull-right zmdi-hc-fw"></i></div>
                            <ul class="list-unstyled">
                                <li><a class="btn-addBook" href="#" data-process="'.$LinksRoute.'process/checkDataAdmin.php" data-href="'.$LinkRouteAdmin.'admininventory.php"><i class="zmdi zmdi-book zmdi-hc-fw"></i>&nbsp;&nbsp; Nueva Carpeta</a></li>
