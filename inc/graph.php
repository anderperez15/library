...
<div class="page-header">
  <h2 class="all-tittles">préstamos <small>por área</small></h2>
</div>
<div class="row">
    <div class="col-xs-12">
        <h3 class="text-center all-tittles">préstamos de usuario por área año <?php echo $DataI['Year']; ?></h3>
        <div class="table-responsive">
            <table class="table table-hover text-center">
                <thead>
                    <tr class="success">
        ...
        <p class="lead text-center"><strong><i class="zmdi zmdi-info-outline"></i>&nbsp; ¡Importante!</strong> Para imprimir esta tabla ve a la sección de reportes y selecciona “Préstamos entregados (por áreas)”</p>
    </div>
</div>
<div class="page-header">
  <h2 class="all-tittles">carpetas <small>por categorías</small></h2>
</div>
<div class="row">
    <div class="col-xs-12">
        <h3 class="text-center all-tittles">carpetas por categorías año <?php echo $DataI['Year']; ?></h3>
        <div class="table-responsive">
            <table class="table table-hover text-center">
                <thead>
                    <tr class="success">
        ...
        <p class="lead text-center"><strong><i class="zmdi zmdi-info-outline"></i>&nbsp; ¡Importante!</strong> Para imprimir esta tabla ve a la sección de reportes y selecciona “Reporte Carpetas por Categoría”</p>
    </div>
</div>
<?php
